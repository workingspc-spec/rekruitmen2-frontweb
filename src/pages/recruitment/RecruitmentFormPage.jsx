    ...
    <div className="space-y-5 max-w-3xl mx-auto">
      <div className="page-header">
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate(-1)}
            className="p-2 -ml-2 rounded-xl text-slate-400 hover:bg-slate-100 hover:text-navy transition-all duration-150 shrink-0"
            title="Kembali"
          >
            <ArrowLeft size={20} />
          </button>
          ...
          <div>
            <h1 className="page-title">
              {isEdit ? 'Edit Permintaan' : 'Buat Permintaan'}
            </h1>
            {isEdit && (
